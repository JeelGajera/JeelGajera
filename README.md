...
Engineer and learner. I turn ideas into working systems — developer tools, AI and data workflows, and web apps built to be tried, inspected, and grown with.

**Now** — exploring ML, TensorFlow, and deeper system design.
...
<table>
  <tr>
    <td width="42">🛡️</td>
    <td><b><a href="https://github.com/JeelGajera/OpenInvar">OpenInvar</a></b><br/>Deterministic integrity checks for AI-written code — catches test tampering, contract erosion, and broken architecture rules at the edit, the commit, or in CI. No model in the loop</td>
  </tr>
  <tr>
    <td width="42">⚛️</td>
...
- 🛒 [eshope](https://github.com/JeelGajera/eshope) — Django marketplace project with dashboard and e-commerce flows
- 🐦 [Twitter-Clone](https://github.com/JeelGajera/Twitter-Clone) — React and Firebase Twitter clone with feed, posting, and realtime app patterns
...
<details>
<summary><b>🤖 AI, Data & Analytics</b></summary>
<br/>

- 🌦️ [weather-time-agent](https://github.com/JeelGajera/weather-time-agent) — Google ADK agent answering weather and local-time questions via OpenWeatherMap
...
- 🩺 [medical-data-visualizer](https://github.com/JeelGajera/medical-data-visualizer) — Data cleaning and visualization project for medical metrics
- 🧮 [demographic-data-analyzer](https://github.com/JeelGajera/demographic-data-analyzer) — Demographic dataset analysis with Python
...
- 🚀 [Chandrayaan_3_TDD_Assessment](https://github.com/JeelGajera/Chandrayaan_3_TDD_Assessment) — Test-driven development kata modelling the Chandrayaan 3 lander
- 🧱 [fcc-arithmetic-formatter](https://github.com/JeelGajera/fcc-arithmetic-formatter) — freeCodeCamp scientific computing project
- ⏱️ [fcc-time-calculator](https://github.com/JeelGajera/fcc-time-calculator) — freeCodeCamp time calculator challenge
- 💰 [fcc-budget-app](https://github.com/JeelGajera/fcc-budget-app) — freeCodeCamp budget app challenge
- 📐 [fcc-polygon-area-calculator](https://github.com/JeelGajera/fcc-polygon-area-calculator) — freeCodeCamp polygon area challenge
...
- 📊 [mean-variance-standard-deviation-calculator](https://github.com/JeelGajera/mean-variance-standard-deviation-calculator) — freeCodeCamp statistics challenge with NumPy
...
[![An image of @jeelgajera's Holopin badges](https://holopin.me/jeelgajera)](https://holopin.io/@jeelgajera)
